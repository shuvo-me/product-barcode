...
const {
  ...
  pending,
  error,
} = await useFetch(() => `https://dummyjson.com/products`, {
...
<template>
  <div>
    <div
      class="flex flex-column sm:flex-row flex-wrap space-y-4 sm:space-y-0 items-center justify-end gap-5 pb-4"
    >
      <div>
        <button
    ...
    <table class="w-full text-sm text-left text-gray-500">
      ...
      <tbody>
        <tr
          ...
          :key="product.id"
        >
          <th scope="row" class="p-5">
            <div class="w-[80px] overflow-hidden rounded-md">
              <img
          ...
          <td class="px-6 py-4" v-text="product.title" />
          <td class="px-6 py-4" v-text="product.price" />
          <td class="px-6 py-4" v-text="product.rating" />
          <td class="px-6 py-4">
            <svg
              class="barcode"
              jsbarcode-format="auto"
              :jsbarcode-value="product.id"
